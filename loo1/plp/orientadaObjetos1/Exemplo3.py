...
class Exemplo3:
    ...
    def criar_programa() -> Programa:
        ...
        parametro_v = ListaDeclaracaoParametro(
        ...
        metodo_insere = DecProcedimentoSimples(insere, parametro_v, corpo_insere)

        corpo_print = Exemplo3.sequencial(
            Write(this_valor),
            IfThenElse(
        ...
        metodos = DecProcedimentoComposta(metodo_insere, metodo_print)
    ...
    def executar(self):
        ...
        if not programa.checa_tipo(ContextoCompilacaoOO1(ListaValor())):
            raise TypeError("O Exemplo3 não está bem tipado.")
