...
class ExpEquals(ExpBinaria):
    ...
    def avaliar(self, amb: AmbienteExecucao) -> Valor:
        esq = exigir(self.get_esq().avaliar(amb), ValorConcreto, "valor concreto", self.get_operador())
        dir = exigir(self.get_dir().avaliar(amb), ValorConcreto, "valor concreto", self.get_operador())
